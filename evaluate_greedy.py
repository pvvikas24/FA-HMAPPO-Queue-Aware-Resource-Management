...
def evaluate(args):
    ...
    for episode in range(1, args.episodes + 1):
        ...
        while not done:
            action = np.zeros((cfg.env.n_devices, env.action_dim))
            action[:,0] = 0.8
    ...
    output = cfg.paths.results / "evaluation_metrics.csv"
...
if __name__ == "__main__":
    ...
    parser.add_argument("--checkpoint", default="checkpoints/fahmappo_final.pt")
